...
class _AdminSongFormScreenState extends ConsumerState<AdminSongFormScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (_isEditing) {
      await ref
          .read(adminSongNotifierProvider.notifier)
    ...
    final state = ref.read(adminSongNotifierProvider);
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    final state = ref.watch(adminSongNotifierProvider);
  ...
  Widget _buildSubmitButton(AppLocalizations l10n, bool isLoading) {
    return ElevatedButton(
      ...
      child: isLoading
          ...
          : Text(
              _isEditing ? l10n.saveSongChanges : l10n.uploadAndSaveSong,
